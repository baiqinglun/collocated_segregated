...
do
    ...
    do
        ...
        sed -i "s/conductivity_coefficient = 10000/conductivity_coefficient = $con/g" main.py
        C:\\ProgramData\\Anaconda3\\envs\\convective%20heat%20transfer\\python.exe main.py
